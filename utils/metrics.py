...
class Result(object):
    def __init__(self, mask_min, mask_max):
        ...
        self.mean_err, self.median_err = 0, 0
    ...
    def evaluate(self, output, target):
        ...
        self.theta1 = float((abs_diff < 20).float().mean())
        self.theta2 = float((abs_diff < 10).float().mean())
        self.theta3 = float((abs_diff < 5).float().mean())

        self.mean_err = float(abs_diff.mean())
        self.median_err = float(abs_diff.median())
