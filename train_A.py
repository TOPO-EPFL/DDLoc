...
parser.add_argument('--total_epoch_num', type=int, default=150, help='total number of epoch')
...
parser.add_argument('--isbuffer', action='store_true', help='whether to use discriminitaor buffer')
parser.add_argument('--save_steps', type=int, default=10, help='frequency to save the checkpoint')
parser.add_argument('--rho', type=float, default=0.9, help='mask sparsity parameter rho')
...
datasets_xLabels_joint = Joint_coord_dataLoader(real_root_dir=args.path_to_real, syn_root_dir=args.path_to_syn,
								img_normalize=args.img_normalize, paired_data=args.data_ispaired)
