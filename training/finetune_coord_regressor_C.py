...
class finetune_coord_regressor_C(base_model):
	def __init__(self, args, dataloaders_xLabels_joint):
		super(finetune_coord_regressor_C, self).__init__(args)
		...
		if self.isTrain:
			...
			if self.start_epoch > 0:
				...
				# load the "best" coordRegressor C (from step 5)
				preTrain_path = os.path.join(os.getcwd(), self.exp_dir, 'jointly_train_coord_regressor_C_and_attention_module_A')
	...
	def _get_project_name(self):
		return 'finetune_coord_regressor_C'
